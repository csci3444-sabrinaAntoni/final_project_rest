...
var TeacherRestController = function(TeacherModel) {
    ...
    /**
     * Fulfills GET for an id in url REST requests.
     ...
     * 
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 0, "name":"sabrina_0", "lastname":"antoni_0", "title": "professor", "age":200, "isFullTime":false}' http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -d     '{"teacherId": 1, "name":"sabrina_1", "lastname":"antoni_1", "title": "adjunct", "age":201, "isFullTime":false}' http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" --data '{"teacherId": 2, "name":"sabrina_2", "lastname":"antoni_2", "title": "dr", "age":202, "isFullTime":true}'  http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 3, "name":"sabrina_3", "lastname":"antoni_3", "title": "prof", "age":203, "isFullTime":true}'  http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 4, "name":"sabrina_4", "lastname":"antoni_4", "title": "adjunct", "age":204, "isFullTime":true}'  http://localhost:9016/teachers
     * 
     ...
     * 
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"sabrina_0_update",   "lastname":"antoni_0", "age":200, "isFullTime":false}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"sabrina_0_update_2", "lastname":"antoni_0", "age":200, "isFullTime":false, "updatedOn":"2017-12-03T12:39:06.446Z"}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"sabrina_0_update_3", "lastname":"antoni_0", "age":200, "isFullTime":false, "updatedOn":"'"$(date +%Y-%m-%dT%H:%M:%S)"'"}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 3, "name":"sabrina_3_update",   "lastname":"antoni_3", "age":200, "isFullTime":false, "updatedOn":"'"$(date +%Y-%m-%dT%H:%M:%S)"'"}' http://localhost:9016/teachers/5a2f2505c96a552334fdc762
     * 
     ...
     * 
       curl -X PATCH -H "Content-Type: application/json" -i -d '{ "age":123, "isFullTime":false}' http://localhost:9016/teachers/5a23f72a1fb    00a38f0a814a9
     * 
     * @param {*} req 
     * @param {*} res 
     */
